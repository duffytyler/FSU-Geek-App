...
wired_images = browser.find_elements(By.XPATH,
                                     "//*[@id='main-content']/div[1]/div[1]/div/div/div[*]/div/div[1]/a/span/div/div/picture/img")
...
# finds the url and title elements
mainarticle = browser.find_elements(By.CSS_SELECTOR, "body > div.skin-wrapper > div.FeaturedArticles-wrapper > div > article > a")
toparticles = browser.find_elements(By.CSS_SELECTOR, "body > div.skin-wrapper > div.FeaturedArticles-wrapper > div > div > * > a")
...
# finds the image url elements
mainimage = browser.find_elements(By.CSS_SELECTOR, "body > div.skin-wrapper > div.FeaturedArticles-wrapper > div > article > a > img")
topimages = browser.find_elements(By.CSS_SELECTOR, "body > div.skin-wrapper > div.FeaturedArticles-wrapper > div > div > * > a > img")
